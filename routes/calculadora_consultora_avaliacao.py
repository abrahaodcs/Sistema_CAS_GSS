# calculadora_consultora.py

from flask import Blueprint, render_template, request

calculadora_consultora_avaliacao_bp = Blueprint('calculadora_consultora_avaliacao', __name__)

@calculadora_consultora_avaliacao_bp.route('/calculadora_consultora_avaliacao', methods=['GET', 'POST'])
def calculadora_consultora_avaliacao():
    if request.method == 'POST':
        ...
        return render_template('calculadora_consultora_avaliacao.html',
