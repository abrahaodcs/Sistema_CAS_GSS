...
calculadora_consultora_bp = Blueprint('calculadora_consultora', __name__)

@calculadora_consultora_bp.route('/calculadora_consultora', methods=['GET', 'POST'])
def calculadora_consultora():
    if request.method == 'POST':
        ...
        return render_template('calculadora_consultora.html',
