# calculadora_especialista.py

from flask import Blueprint, render_template, request

calculadora_especialista_bp = Blueprint('calculadora_especialista', __name__)

@calculadora_especialista_bp.route('/calculadora_especialista', methods=['GET', 'POST'])
def calculadora_especialista():
    if request.method == 'POST':
        ...
        return render_template('calculadora_especialista.html',
